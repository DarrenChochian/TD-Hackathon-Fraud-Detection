...
```yaml openapi-filtered.json delete /assistants/{assistant_id}
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/{assistant_id}:
    delete:
      ...
      description: Permanently delete an assistant and all its associated threads and documents.
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/AssistantDeleteResponse'
        '422':
