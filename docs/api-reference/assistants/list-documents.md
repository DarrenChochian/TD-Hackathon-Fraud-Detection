...
```yaml openapi-filtered.json get /assistants/{assistant_id}/documents
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/{assistant_id}/documents:
    get:
      ...
      description: List all documents associated with a specific assistant.
      operationId: list_assistant_documents_assistants__assistant_id__documents_get
      security:
        - APIKeyHeader: []
      parameters:
        - name: assistant_id
          ...
          content:
            application/json:
              schema:
                ...
                title: Response List Assistant Documents Assistants  Assistant Id  Documents Get
        '422':
