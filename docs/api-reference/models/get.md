...
```yaml openapi-filtered.json get /models/{model_name}
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /models/{model_name}:
    get:
      ...
      description: Get detailed information about a specific model by its name.
      operationId: get_model_by_name_models__model_name__get
      security:
        - APIKeyHeader: []
      parameters:
        - name: model_name
