...
```yaml openapi-filtered.json get /models/providers
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /models/providers:
    get:
      ...
      description: Get a list of all unique model providers available in the system.
      operationId: list_providers_models_providers_get
      responses:
        '200':
