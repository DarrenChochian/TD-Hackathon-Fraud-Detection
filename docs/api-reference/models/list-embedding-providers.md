...
```yaml openapi-filtered.json get /models/embedding/providers
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /models/embedding/providers:
    get:
      tags:
        - Models
      summary: List All Embedding Model Providers
      description: Get a list of all unique embedding model providers available in the system.
      operationId: list_embedding_providers_models_embedding_providers_get
      responses:
        '200':
    ...
    ProvidersListResponse:
      properties:
        providers:
          ...
          type: array
          title: Providers
          description: List of unique providers
        total:
          type: integer
          title: Total
      ...
      description: Response schema for listing providers.
  securitySchemes:
    APIKeyHeader:
      type: apiKey
      in: header
