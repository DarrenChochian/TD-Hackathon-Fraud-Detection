...
```yaml openapi-filtered.json get /models/provider/{provider_name}
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /models/provider/{provider_name}:
    get:
      ...
      description: Get all models from a specific provider.
      operationId: list_models_by_provider_models_provider__provider_name__get
      security:
        - APIKeyHeader: []
      parameters:
        - name: provider_name
