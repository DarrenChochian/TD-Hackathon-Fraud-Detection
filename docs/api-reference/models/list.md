...
```yaml openapi-filtered.json get /models
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /models:
    get:
      ...
      description: Get a list of all available models with their specifications (excluding pricing information).
        ...
        - name: supports_tools
          ...
          schema:
            anyOf:
              - type: boolean
              - type: 'null'
            description: Filter by tool/function calling support
        ...
        - name: min_context
          ...
          schema:
            anyOf:
              - type: integer
              - type: 'null'
            description: Minimum context limit
            title: Min Context
          description: Minimum context limit
        - name: max_context
          in: query
          ...
          schema:
            anyOf:
              - type: integer
              - type: 'null'
            description: Maximum context limit
            title: Max Context
          description: Maximum context limit
        - name: skip
          in: query
...
components:
  schemas:
    ModelsListResponse:
      ...
      description: Response schema for listing models.
    ModelRead:
      properties:
        name:
          type: string
        ...
        api_mode:
          anyOf:
            ...
            - type: 'null'
          title: Api Mode
          description: API mode/routing hint (e.g., chat_completions, responses, completions)
      ...
      required:
        ...
        - context_limit
      title: ModelRead
      description: Schema for reading model information (excludes cost fields and internal settings).
    HTTPValidationError:
      properties:
        detail:
          items:
