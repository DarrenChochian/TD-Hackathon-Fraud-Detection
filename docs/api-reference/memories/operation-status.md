...
> Get the status of a memory add/update/delete operation by operation_id.

## OpenAPI

```yaml openapi-filtered.json get /assistants/memories/operations/{operation_id}
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/memories/operations/{operation_id}:
    get:
      tags:
        - Memories
      summary: Get Memory Operation Status
      description: Get the status of a memory add/update/delete operation by operation_id.
      operationId: get_memory_operation_status_assistants_memories_operations__operation_id__get
      security:
        - APIKeyHeader: []
      parameters:
        - name: operation_id
      ...
      responses:
        '200':
          ...
          content:
            application/json:
              schema:
                $ref: '#/components/schemas/MemoryOperationStatusResponse'
        '422':
  ...
  schemas:
    MemoryOperationStatusResponse:
      ...
      required:
        ...
        - status
        - created_at
      title: MemoryOperationStatusResponse
    HTTPValidationError:
      properties:
        detail:
          items:
