...
```yaml openapi-filtered.json put /assistants/{assistant_id}/memories/{memory_id}
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/{assistant_id}/memories/{memory_id}:
    put:
      ...
      description: Update a specific memory in both database and vector store.
      operationId: update_memory_assistants__assistant_id__memories__memory_id__put
      security:
        - APIKeyHeader: []
      parameters:
        - name: assistant_id
