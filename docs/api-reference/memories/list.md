...
> Get all memories for a specific assistant.

## OpenAPI

```yaml openapi-filtered.json get /assistants/{assistant_id}/memories
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/{assistant_id}/memories:
    get:
      ...
      description: Get all memories for a specific assistant.
      operationId: get_all_memories_assistants__assistant_id__memories_get
      security:
        - APIKeyHeader: []
      parameters:
        - name: assistant_id
...
components:
  schemas:
    MemoriesListResponse:
      ...
      description: Schema for listing all memories
    MemoryResponse:
      properties:
        id:
          type: string
        ...
        updated_at:
          anyOf:
            ...
            - type: 'null'
          title: Updated At
          description: Memory update timestamp
      type: object
      required:
        - id
        - content
      title: MemoryResponse
      description: Schema for memory responses from backboard_memory
    HTTPValidationError:
      properties:
        detail:
          items:
