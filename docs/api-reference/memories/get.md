...
```yaml openapi-filtered.json get /assistants/{assistant_id}/memories/{memory_id}
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/{assistant_id}/memories/{memory_id}:
    get:
      ...
      operationId: get_memory_by_id_assistants__assistant_id__memories__memory_id__get
      security:
        - APIKeyHeader: []
      parameters:
        - name: assistant_id
