...
> Get memory statistics and limits for a specific assistant.

## OpenAPI

```yaml openapi-filtered.json get /assistants/{assistant_id}/memories/stats
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /assistants/{assistant_id}/memories/stats:
    get:
      ...
      description: Get memory statistics and limits for a specific assistant.
      operationId: get_memory_stats_assistants__assistant_id__memories_stats_get
      security:
        - APIKeyHeader: []
      parameters:
        - name: assistant_id
          ...
          content:
            application/json:
              schema:
                ...
                title: Response Get Memory Stats Assistants  Assistant Id  Memories Stats Get
        '422':
