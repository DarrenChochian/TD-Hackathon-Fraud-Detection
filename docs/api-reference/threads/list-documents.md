...
```yaml openapi-filtered.json get /threads/{thread_id}/documents
openapi: 3.1.0
info:
  title: Backboard API
  description: >-
...
paths:
  /threads/{thread_id}/documents:
    get:
      tags:
        - Threads
      summary: List Thread Documents
      description: List all documents associated with a specific thread.
      operationId: list_thread_documents_threads__thread_id__documents_get
      security:
        - APIKeyHeader: []
      parameters:
        - name: thread_id
          ...
          content:
            application/json:
              schema:
                ...
                title: Response List Thread Documents Threads  Thread Id  Documents Get
        '422':
